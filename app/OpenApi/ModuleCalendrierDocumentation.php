...
#[OA\Delete(
    path: '/parametres/modules-calendrier/{id}', operationId: 'supprimerModuleCalendrier', summary: 'Supprimer un module de calendrier', description: 'Suppression autorisée même avec des créneaux. Les créneaux sont supprimés logiquement et les séances futures prévues retirées. Les événements associés sont supprimés en cascade.', tags: ['Modules calendrier'], security: [['sanctum' => []]],
    parameters: [new OA\Parameter(name: 'id', in: 'path', required: true, schema: new OA\Schema(type: 'integer', minimum: 1))],
